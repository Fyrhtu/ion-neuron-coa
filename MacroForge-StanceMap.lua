-- MacroForge CoA / Ascension 3.3.5 stance map
...
MacroForge.StanceMap = MacroForge.StanceMap or {}
...
function StanceMap:Refresh(class)
	class = class or MacroForge.class
	self.slots = {}
	self.numSlots = 0
...
function MacroForge:RefreshStanceMap()
...
function MacroForge:OnStanceMapUpdated()
