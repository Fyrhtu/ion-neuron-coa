...
L["Custom_Option"] = "For custom states, add a desired state string (/macroforge state custom <state string>) where <state string> is a semicolon seperated list of state conditions"
...
L["Pet Actions can not be added to MacroForge bars at this time."] = true
...
Below you will find a text representation of your MacroForge profile.
